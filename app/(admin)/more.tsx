...
const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    subtitle: "Manage bills, meter readings, and payments",
    icon: "cash",
    route: "/(admin)/billing",
    color: "#059669",
  },
  {
    ...
    subtitle: "Schedule and track portfolio-wide maintenance",
    icon: "calendar",
  ...
  },
  {
    ...
    subtitle: "Send announcements to tenants and staff",
    icon: "megaphone",
    route: "/(admin)/broadcast-notifications",
    color: "#7C3AED",
  },
  {
    id: "visitors",
    title: "Portfolio Visitors",
    subtitle: "Track and manage visitor access",
    icon: "person-add",
  ...
  {
    id: "parcels",
    title: "Portfolio Parcels",
    subtitle: "Manage package delivery and pickup",
    icon: "cube",
    route: "/(admin)/parcels",
    color: "#EA580C",
  },
