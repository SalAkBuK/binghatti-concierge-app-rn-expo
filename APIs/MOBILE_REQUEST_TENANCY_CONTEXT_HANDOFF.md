...
Use this file for the React Native mobile app integration of `requestTenancyContext` on owner-facing request screens.

## Scope

- Applies to owner request list and owner request detail surfaces.
- Tenant request screens do not need lifecycle grouping from this payload unless product explicitly adds it later.
- Backend behavior is now consistent across owner portfolio, building requests, and provider requests.
